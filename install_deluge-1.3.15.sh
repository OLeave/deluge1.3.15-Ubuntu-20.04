...
#wget -q --show-progress --progress=bar:force http://archive.ubuntu.com/ubuntu/pool/main/c/chardet/python-chardet_2.3.0-2_all.deb           # Required to install on 20.10 but causes issues
#wget -q --show-progress --progress=bar:force http://security.ubuntu.com/ubuntu/pool/universe/p/pyxdg/python-xdg_0.25-4ubuntu1.1_all.deb    # Required to install on 20.10 but causes issues
wget -q --show-progress --progress=bar:force http://archive.ubuntu.com/ubuntu/pool/universe/d/deluge/deluge-common_1.3.15-2_all.deb
